...
one = Button(root, text="1", bg="#F6DF42",
             command=lambda: printcommand(1), height=1, width=7)
one.grid(row=2, column=0)

two = Button(root, text="2", bg="#F6DF42",
             command=lambda: printcommand(2), height=1, width=7)
two.grid(row=2, column=1)

three = Button(root, text="3", bg="#F6DF42",
               command=lambda: printcommand(3), height=1, width=7)
three.grid(row=2, column=2)

four = Button(root, text="4", bg="#F6DF42",
              command=lambda: printcommand(4), height=1, width=7)
four.grid(row=3, column=0)

five = Button(root, text="5", bg="#F6DF42",
              command=lambda: printcommand(5), height=1, width=7)
five.grid(row=3, column=1)

six = Button(root, text="6", bg="#F6DF42",
             command=lambda: printcommand(6), height=1, width=7)
six.grid(row=3, column=2)

seven = Button(root, text="7", bg="#F6DF42",
               command=lambda: printcommand(7), height=1, width=7)
seven.grid(row=4, column=0)

eight = Button(root, text="8", bg="#F6DF42",
               command=lambda: printcommand(8), height=1, width=7)
eight.grid(row=4, column=1)

nine = Button(root, text="9", bg="#F6DF42",
              command=lambda: printcommand(9), height=1, width=7)
nine.grid(row=4, column=2)

zero = Button(root, text="0", bg="#F6DF42",
              command=lambda: printcommand(0), height=1, width=7)
zero.grid(row=5, column=1)

plus = Button(root, text="+", bg="#F6DF42",
              command=lambda: printcommand("+"), height=1, width=7)
